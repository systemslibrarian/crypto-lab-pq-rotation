 ...
 *    files the node under `incomplete`. The `.gloss` callouts tint the surface
 *    toward cyan and the stepper cards were translucent, so their text
 ...
 *    ML-DSA signatures are kilobytes of hex and the inventory table is wide, so
 *    at 380px much of both is clipped away. Content scrolled past the client box is not dimmed or partly
